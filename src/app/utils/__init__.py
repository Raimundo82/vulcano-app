...
# Import utility functions from word_utils.py
from .word_utils import generate_word_with_table

# Optionally, define what gets imported when using `from app.utils import *`
__all__ = ["authenticate_user", "generate_pdf_with_table", "generate_word_with_table"]
